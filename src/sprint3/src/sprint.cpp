...
private:
    ...
    /**
     * @brief Converts an occupancy grid to an OpenCV image.
     * @param grid The occupancy grid message to convert.
     * @return A cv::Mat representing the occupancy grid as an image.
     */
    ...
    /**
     * @brief Checks for new detected cylinder points and adds them if not detected before.
     * @param circle_points Vector of detected cylinder points.
     */
    ...
    /**
     * @brief Detects clusters of points that may represent circles.
     * @param points Vector of points from the laser scan.
     * @return Vector of detected circle center points.
     */
    ...
    /**
     * @brief Detects an arc within a cluster of points and calculates the circle center.
     * @param cluster The cluster of points.
     * @param circle_centers The vector to store detected circle centers.
     */
     ...
     * @param radius The radius of the calculated circle.
     * @param center The center of the calculated circle.
     * @return True if the circle is successfully calculated, false otherwise.
     */
    ...
    /**
     * @brief Draws a detected cylinder on the occupancy grid map.
     * @param x X-coordinate of the cylinder in map frame.
     * @param y Y-coordinate of the cylinder in map frame.
     */
    void drawOnMap(double x, double y)
    {
        ...
        {
            // Draw a purple circle representing the detected cylinder
            cv::circle(map_image_, cv::Point(map_x, map_image_.rows - map_y), 5, cv::Scalar(240, 32, 160), -1);
        }
    ...
    /**
     * @brief Converts the points detected by the laser scan to the map frame.
...
/**
 * @brief Main function to start the CylinderDetector node.
