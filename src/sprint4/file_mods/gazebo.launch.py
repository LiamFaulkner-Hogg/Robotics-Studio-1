...
def generate_launch_description():
    ...
    # Automatically add models path to GAZEBO_MODEL_PATH
    gazebo_model_path = os.path.expanduser('~/git/Main_Project/models')

    declare_gazebo_model_path = SetEnvironmentVariable(
