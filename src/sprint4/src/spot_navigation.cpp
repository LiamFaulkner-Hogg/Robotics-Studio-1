...
private:
    ...
    std::vector<geometry_msgs::msg::PoseStamped> SetGoalPoses()
    {
        ...
        goal_pose.pose.position.x = 7.40;
        goal_pose.pose.position.y = -0.4;
        goal_pose.pose.orientation.z = 0.25;
        goal_pose.pose.orientation.w = 1.0;
        goal_poses.push_back(goal_pose);

        goal_pose.pose.position.x = 5.00;
        ...
        goal_pose.pose.position.y = 7.6;
        goal_pose.pose.orientation.z = 0;
        goal_pose.pose.orientation.w = 1.0;
        goal_poses.push_back(goal_pose);

        goal_pose.pose.position.x = -2.80;
        ...
        goal_pose.pose.position.y = 0.60;
        goal_pose.pose.orientation.z = 1;
        goal_pose.pose.orientation.w = 1;
        goal_poses.push_back(goal_pose);

        goal_pose.pose.position.x = -1.8;
        goal_pose.pose.position.y = -6.1;
        goal_pose.pose.orientation.z = 0.5;
        goal_pose.pose.orientation.w = 1;
        goal_poses.push_back(goal_pose);

        goal_pose.pose.position.x = 6.2;
